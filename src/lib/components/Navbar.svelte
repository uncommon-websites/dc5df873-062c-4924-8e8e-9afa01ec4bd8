...
<nav class="bg-black text-white py-4 px-6 flex items-center justify-between sticky top-0 z-50 border-b border-gray-900">
  <div class="flex items-center gap-8">
    <a href="/" class="flex items-center gap-2">
      ...
      <span class="text-xl font-medium tracking-tight">Clearout Co</span>
    </a>
  ...
  <div class="flex items-center gap-4">
    <a href="tel:555-0100" class="text-gray-300 hover:text-white transition-colors text-[13px] hidden md:block">
      (555) 555-0100
    </a>
